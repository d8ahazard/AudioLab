...
from rvc.lib.commons import sequence_mask, rand_slice_segments, slice_segments2
from rvc.lib.attentions import Encoder
from rvc.lib.modules import WN, ResidualCouplingBlock
from rvc.lib.models_hifigan import GeneratorNSF
from rvc.lib.models_bigvgan import GeneratorBigVgan
...
class TextEncoder(nn.Module):
    ...
    def forward(self, phone: torch.Tensor, pitch: torch.Tensor, lengths: torch.Tensor, ppg=None):
        ...
        if ppg is not None and hasattr(self, 'ppg_pre'):
