...
import modules.rvc_train.lib.commons as commons
from modules.rvc_train.lib.models import RVCModel
from modules.rvc_train.lib.discriminator import MultiPeriodDiscriminatorV2 as MultiPeriodDiscriminator
from modules.rvc_train.utils import load_checkpoint, latest_checkpoint_path, \
    save_checkpoint, plot_spectrogram_to_numpy, savee, HParams
from modules.rvc_train.data_preparation import (
    DistributedBucketSampler,
    TextAudioCollate,
    TextAudioLoader,
)
from modules.rvc_train.training_utils import (
    discriminator_loss,
    feature_loss,
    generator_loss,
    kl_loss,
)
from modules.rvc_train.mel_processing import mel_spectrogram_torch, spec_to_mel_torch
...
def run_new(
    ...
    run(rank=rank, n_gpus=n_gpus, hps=hparams)
