...
from modules.rvc_train.lib import commons
from modules.rvc_train.lib.commons import get_padding, init_weights
...
class WN(torch.nn.Module):
    ...
    gin_channels describes multi-speaker conditioning
    """
