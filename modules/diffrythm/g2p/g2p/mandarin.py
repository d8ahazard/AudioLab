...
from modules.diffrythm.g2p.g2p.chinese_model_g2p import BertPolyPredict
from modules.diffrythm.g2p.utils.front_utils import *
import os
...
resource_path = os.path.join(app_path, "modules", "diffrythm", "g2p")
