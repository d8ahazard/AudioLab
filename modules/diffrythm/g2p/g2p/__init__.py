...
from modules.diffrythm.g2p.g2p import cleaners
from tokenizers import Tokenizer
from modules.diffrythm.g2p.g2p.text_tokenizers import TextTokenizer
from modules.diffrythm.thirdparty.LangSegment import LangSegment
import json
import re
import os
...
class PhonemeBpeTokenizer:
    ...
    def __init__(self, vacab_path=None):
        if vacab_path is None:
            vacab_path = os.path.join(app_path, "modules", "diffrythm", "g2p", "g2p", "vocab.json")
