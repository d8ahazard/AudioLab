...
class BertPolyPredict:
    def __init__(self, bert_model, jsonr_file, json_file):
        # Create a specific directory for BERT model caches within the models directory
        bert_cache_dir = os.path.join(model_path, "diffrythm", "bert")
        os.makedirs(bert_cache_dir, exist_ok=True)
        
        self.tokenizer = BertTokenizer.from_pretrained(bert_model, do_lower_case=True, cache_dir=bert_cache_dir)
        ...
        onnx_path = os.path.join(bert_model, "poly_bert_model.onnx")
