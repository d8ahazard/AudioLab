...
# Digital processing
from modules.diffrythm.thirdparty.LangSegment.utils.num import num2str
...
#===========================================================================================================
# Word segmentation function: Automatically recognizes and splits words (Chinese/English/Japanese/Korean) in text
# according to different languages, making it more suitable for TTS processing.
# This code is specially created for front-end text multi-language mixed annotation distinction,
# multi-language mixed training, and inference of various TTS projects.
#===========================================================================================================
# (1) Automatic word segmentation: "What are you reading in Korean? Who is your physical education teacher? This conference introduced four iPhone 15 series models."
# (2) Manual word segmentation: "Is your name <ja>Sasaki?</ja>"
# This processing mainly targets (Chinese = zh, Japanese = ja, English = en, Korean = ko), and can actually support up to 97 different languages for mixed processing.
#===========================================================================================================
...
# "<ja>Sasaki<ja>" or "<ja>Sasaki</ja>"
# Error demonstration: "Your name is <ja>Sasaki." Single <ja> tags that appear in this sentence will be ignored and will not be processed.
# ===========================================================================================================
...
# [SSML] <number> = Chinese uppercase number reading (single character)
# [SSML] <telephone> = Numbers converted to Chinese telephone number uppercase characters (single character)
# [SSML] <currency> = Pronounce according to currency amount
# [SSML] <date> = Pronounce according to date format. Supports inputs like 2024年08月24, 2024/8/24, 2024-08, 08-24, 24, etc.
# ===========================================================================================================
class LangSSML:
