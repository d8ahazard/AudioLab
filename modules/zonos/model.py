...
from modules.zonos.codebook_pattern import apply_delay_pattern, revert_delay_pattern
from modules.zonos.conditioning import PrefixConditioner
from modules.zonos.config import ZonosConfig
from modules.zonos.sampling import sample_from_logits
from modules.zonos.speaker_cloning import SpeakerEmbeddingLDA
...
class Zonos(nn.Module):
    ...
    def make_speaker_embedding(self, wav: torch.Tensor, sr: int, s_path) -> torch.Tensor:
        ...
        if self.spk_clone_model is None:
            self.spk_clone_model = SpeakerEmbeddingLDA(speaker_dir=s_path)
