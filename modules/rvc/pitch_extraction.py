...
from modules.rvc.infer.lib.audio import pad_audio, autotune_f0
from modules.rvc.infer.lib.rmvpe import RMVPE
from modules.rvc.utils import get_optimal_threads, get_merge_func
...
class FeatureExtractor:
    ...
    def get_f0_hybrid_computation(
        ...
        def _get_f0(method, params):
            ...
            # Fix: ensure filter_radius is an odd integer before medfilt
